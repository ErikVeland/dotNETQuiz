  ...
  if (current >= questions.length)
    return (
      <main className="min-h-screen p-6 bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100 flex flex-col items-center justify-center">
        {score >= 8 ? (
          <div className="w-full max-w-2xl bg-white dark:bg-gray-800 rounded-lg shadow-2xl border-8 border-pink-200 dark:border-pink-900 p-8 relative overflow-hidden">
            ...
            <div className="text-center relative z-10">
              ...
              <div className="bg-gradient-to-r from-green-100 dark:from-green-900 to-pink-100 dark:to-pink-900 rounded-lg p-6 mb-6 border border-green-200 dark:border-green-800">
              ...
              <div className="grid grid-cols-2 gap-6 mb-8">
                <div className="bg-pink-50 dark:bg-pink-900 rounded-lg p-4 border border-pink-200 dark:border-pink-700">
          ...
          <div className="w-full max-w-xl bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 text-center">
            ...
            <div className="bg-orange-50 dark:bg-orange-900 rounded-lg p-6 mb-6 border border-orange-200 dark:border-orange-800">
  ...
  return (
    <main className="min-h-screen p-6 bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100 flex flex-col items-center">
      <div className="w-full max-w-xl bg-white dark:bg-gray-800 rounded shadow p-6">
        ...
        <div className="bg-pink-50 dark:bg-pink-900 rounded-lg p-4 mb-6 border border-pink-200 dark:border-pink-700">
          ...
          {feedback && (
            <div className="mt-6">
              {q.type === "multiple-choice" && (
                <div className={`p-4 rounded-lg mb-4 ${feedback.isCorrect ? "bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 border border-green-200 dark:border-green-800" : "bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200 border border-red-200 dark:border-red-800"}`}>
