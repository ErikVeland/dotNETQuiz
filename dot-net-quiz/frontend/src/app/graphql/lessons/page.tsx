                            ...
                            <div key={group.topic} className="mb-10">
                                ...
                                <ul className="space-y-2">
                                    {group.lessons.map((lesson, idx) => (
                                        <li
                                            key={lesson.id}
                                            className="bg-gray-100 dark:bg-gray-700 p-4 rounded shadow hover:bg-pink-50 dark:hover:bg-pink-900 cursor-pointer border border-gray-200 dark:border-gray-600"
                                            onClick={() => {
                            ...
                            <>
                                {isLastCategory ? (
                                    <div className="flex flex-col sm:flex-row gap-4 mt-8">
                                        <Link 
                                            href="/" 
                                            className="flex-1 bg-pink-600 dark:bg-pink-700 text-white px-4 py-2 rounded shadow hover:bg-pink-700 dark:hover:bg-pink-600 transition-colors duration-150 font-semibold text-center"
                                        >
                                            Exit Lessons
                                        </Link>
                                        <Link 
                                    ...
                                    <button
                                        className="w-full mt-8 bg-pink-600 dark:bg-pink-700 text-white px-4 py-2 rounded shadow hover:bg-pink-700 dark:hover:bg-pink-600 transition-colors duration-150 font-semibold"
                                        onClick={() => {
