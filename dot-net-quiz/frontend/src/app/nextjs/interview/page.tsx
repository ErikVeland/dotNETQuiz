        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-8">
              ...
              {!passed && (
                <Link href="/nextjs/lessons" className="px-4 py-2 bg-purple-600 dark:bg-purple-700 text-white rounded-lg hover:bg-purple-700 dark:hover:bg-purple-600 transition-colors duration-150 font-semibold">
                  Review Lessons
                </Link>
              )}
              <button
                    ...
                    className={`p-4 border rounded-lg cursor-pointer transition-all duration-200 ${
                      feedback 
                        ...
                        : displayIndex === selected 
                          ...
                          : "border-gray-200 dark:border-gray-600 hover:border-purple-200 dark:hover:border-purple-500 hover:bg-purple-50 dark:hover:bg-purple-900"
                    }`}
                  >
