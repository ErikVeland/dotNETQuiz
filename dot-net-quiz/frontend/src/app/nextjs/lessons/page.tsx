                            ...
                            <div key={group.topic} className="mb-10">
                                ...
                                <ul className="space-y-2">
                                    {group.lessons.map((lesson, idx) => (
                                        <li
                                            key={lesson.id}
                                            className="bg-gray-100 dark:bg-gray-700 p-4 rounded shadow hover:bg-purple-50 dark:hover:bg-purple-900 cursor-pointer border border-gray-200 dark:border-gray-600"
                                            onClick={() => {
