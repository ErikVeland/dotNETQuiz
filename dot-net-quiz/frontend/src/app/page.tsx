  ...
  return (
    <div className="w-full flex flex-col items-center justify-center py-8">
      <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-xl shadow-lg p-6 md:p-8 w-full max-w-6xl flex flex-col items-center border border-gray-200 dark:border-gray-700">
        ...
        <Link href="/playground" className="mb-6 md:mb-8 bg-gray-800 dark:bg-gray-700 text-white px-4 py-2 md:px-6 md:py-2 rounded-full shadow hover:bg-gray-700 dark:hover:bg-gray-600 text-center font-semibold flex items-center transition-all duration-200 hover:scale-105">
