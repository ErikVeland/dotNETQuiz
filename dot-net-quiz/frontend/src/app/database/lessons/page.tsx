    ...
    return (
        ...
        <div className="w-full p-6">
            ...
            <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
                ...
                <h1 className="text-3xl font-bold mb-6 mt-2 text-purple-700 dark:text-purple-300">Learn Databases & Data Modelling Step by Step</h1>
                            ...
                            <div key={group.topic} className="mb-10">
                                ...
                                <ul className="space-y-2">
                                    {group.lessons.map((lesson, idx) => (
                                        <li
                                            key={lesson.id}
                                            className="bg-gray-100 dark:bg-gray-700 p-4 rounded shadow hover:bg-purple-50 dark:hover:bg-purple-900 cursor-pointer transition-colors duration-150 border border-gray-200 dark:border-gray-600"
                                            onClick={() => {
                                                setSelectedTopic(group.topic);
                                                setSelectedIndex(idx);
                                            }}
                                        >
                                            <div className="font-semibold text-purple-700 dark:text-purple-300">{lesson.title}</div>
                ...
                {selectedTopic !== null && currentLesson && (
                    ...
                    <div className="bg-gray-100 dark:bg-gray-700 p-6 rounded-xl shadow-lg space-y-4 mt-4 border border-gray-200 dark:border-gray-600">
                        ...
                        <div>
                            <h3 className="font-semibold mt-4 text-purple-700 dark:text-purple-300">SQL Example:</h3>
                        ...
                        <div>
                            <h3 className="font-semibold mt-4 text-purple-700 dark:text-purple-300">Expected Output:</h3>
                            <pre className="bg-black text-white p-4 rounded text-sm whitespace-pre-wrap overflow-x-auto border border-gray-700 dark:border-gray-600">
                            ...
                            <>
                                {isLastCategory ? (
                                    <div className="flex flex-col sm:flex-row gap-4 mt-8">
                                        <Link 
                                            href="/" 
                                            className="flex-1 bg-purple-600 dark:bg-purple-700 text-white px-4 py-2 rounded shadow hover:bg-purple-700 dark:hover:bg-purple-600 transition-colors duration-150 font-semibold text-center"
                                        >
                                            Exit Lessons
                                        </Link>
                                        <Link 
                                    ...
                                    <button
                                        className="w-full mt-8 bg-purple-600 dark:bg-purple-700 text-white px-4 py-2 rounded shadow hover:bg-purple-700 dark:hover:bg-purple-600 transition-colors duration-150 font-semibold"
                                        onClick={() => {
