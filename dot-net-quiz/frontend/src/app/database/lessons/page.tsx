                            ...
                            <div key={group.topic} className="mb-10">
                                ...
                                <ul className="space-y-2">
                                    {group.lessons.map((lesson, idx) => (
                                        <li
                                            key={lesson.id}
                                            className="bg-gray-100/30 dark:bg-gray-700/30 backdrop-blur-sm p-4 rounded shadow hover:bg-purple-50 dark:hover:bg-purple-900 cursor-pointer transition-colors duration-150 border border-gray-200 dark:border-gray-600"
                                            onClick={() => {
                                ...
                                {isLastCategory ? (
                                    <div className="flex flex-col sm:flex-row gap-4 mt-8">
                                        ...
                                        <Link 
                                            ...
                                            className="flex-1 bg-gradient-to-r from-purple-500 via-indigo-500 to-blue-500 text-white px-4 py-2 rounded shadow hover:from-purple-600 hover:via-indigo-600 hover:to-blue-600 transition-all duration-150 font-semibold text-center"
                                        >
                                            Start Database Quiz
                                        </Link>
                                    </div>
