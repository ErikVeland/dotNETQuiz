        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-8">
              ...
              {score < Math.ceil(shuffledQuestions.length * 0.7) && (
                <Link href="/typescript/lessons" className="px-4 py-2 bg-indigo-600 dark:bg-indigo-700 text-white rounded-lg hover:bg-indigo-700 dark:hover:bg-indigo-600 transition-colors duration-200 font-semibold">
                  Review Lessons
                </Link>
              )}
              <button
            ...
            {score >= Math.ceil(shuffledQuestions.length * 0.7) && (
              <div className="mt-8 p-6 border-2 border-blue-200 dark:border-blue-700 rounded-xl bg-blue-50 dark:bg-blue-900">
                  ...
                  <div 
                    ...
                    className={`p-4 border rounded-lg cursor-pointer transition-all duration-200 ${
                      feedback 
                        ...
                        : displayIndex === selected 
                          ? "bg-blue-50 dark:bg-blue-900 border-blue-300 dark:border-blue-600 shadow-sm" 
                          : "border-gray-200 dark:border-gray-600 hover:border-blue-200 dark:hover:border-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900"
                    }`}
                  >
