...
export default function TailwindLessonsPage() {
    ...
    const { data, loading, error } = useQuery(TAILWIND_LESSONS_QUERY);
    ...
    if (loading) return <main className="p-6">Loading Tailwind lessons...</main>;
    if (error) return <main className="p-6 text-red-600 dark:text-red-400">Error loading Tailwind lessons.</main>;
